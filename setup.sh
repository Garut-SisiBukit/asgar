...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Garut-SisiBukit/asgar/main/"
start=$(date +%s)
secs_to_human() {
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/AJSvpnjoss"},{"text":"Contack","url":"https://wa.me/6281214726068"}]]}'
...
wget raw.githubusercontent.com/Garut-SisiBukit/asgar/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/Garut-SisiBukit/asgar/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/Garut-SisiBukit/asgar/main/Cfg/m-noobz 
